...
HD_PWD='D:/USA/video/Verilog_Vivado_FIFO/prj_FIFO/prj_FIFO.runs/fifo_test_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_test.tcl
